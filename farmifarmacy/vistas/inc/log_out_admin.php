	...
	function cerrar_sesion_administrador(){
        ...
        Swal.fire({
            ...
            if(result.isConfirmed){
                ...
                datos.append("token","<?php echo $ins_login->encryption($_SESSION['token_farmifarmacy']); ?>");
                datos.append("usuario","<?php echo $ins_login->encryption($_SESSION['usuario_farmifarmacy']); ?>");
