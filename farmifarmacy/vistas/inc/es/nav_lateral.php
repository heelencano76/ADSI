<section class="full-box nav-lateral">
    ...
    <div class="full-box nav-lateral-content scroll">
        <figure class="full-box nav-lateral-avatar">
            ...
            <img src="<?php echo SERVERURL; ?>vistas/assets/avatar/<?php echo $_SESSION['foto_farmifarmacy']; ?>" class="img-fluid" alt="Avatar">
            <figcaption class="roboto-medium text-center">
                <?php echo $_SESSION['nombre_farmifarmacy']; ?> <br><small class="roboto-condensed-light"><?php echo $_SESSION['cargo_farmifarmacy']; ?></small>
            </figcaption>
        </figure>
        ...
        <nav class="full-box nav-lateral-menu">
            <ul>
                ...
                <?php if($_SESSION['cargo_farmifarmacy']=="Administrador"){ ?>
                <li>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <?php } ?>
                        <li>
                            <a href="<?php echo SERVERURL.DASHBOARD."/admin-update/".$ins_login->encryption($_SESSION['id_farmifarmacy']); ?>/"><i class="fas fa-user-cog fa-fw"></i> &nbsp; Cuenta</a>
                        </li>
                    </ul>
                </li>
