<header class="header full-box bg-white">
    <div class="header-brand full-box">
        <a href="<?php echo SERVERURL; ?>index/">
            <img src="<?php echo SERVERURL; ?>vistas/assets/img/logo.jpeg" alt="<?php echo COMPANY; ?>" class="img-fluid">
        </a>
    </div>
    ...
    <div class="header-options full-box">
        <nav class="header-navbar full-box poppins-regular font-weight-bold scroll" onclick="show_menu_mobile()" >
            <ul class="list-unstyled full-box" >
                ...
                <?php if(!isset($_SESSION['cargo_farmifarmacy'])){ ?>
                <li>
        ...
        <?php if(isset($_SESSION['cargo_farmifarmacy']) && ($_SESSION['cargo_farmifarmacy']=="Administrador" || $_SESSION['cargo_farmifarmacy']=="Cajero")){ ?>
            <div class="header-button full-box text-center" id="userMenu" data-mdb-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="<?php echo $_SESSION['usuario_farmifarmacy']; ?>" >
                <i class="fas fa-user-circle"></i>
            </div>
            <div class="dropdown-menu div-bordered popup-login" aria-labelledby="userMenu">
                <p class="text-center" style="padding-top: 10px;">
                    <i class="fas fa-user-circle fa-3x"></i><br>
                    <small><?php echo $_SESSION['usuario_farmifarmacy']; ?></small>
                </p>
