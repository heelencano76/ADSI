...
<div class="full-box page-header">
    ...
    <p class="lead">
        ¡Bienvenido <strong><?php echo $_SESSION['nombre_farmifarmacy']." ".$_SESSION['apellido_farmifarmacy'];?></strong>! Este es el panel principal del sistema acá podrá encontrar atajos para acceder a los distintos listados de cada módulo del sistema.
    </p>
</div>
...
<div class="full-box tile-container">
    ...
    <?php
        ...
        if($_SESSION['cargo_farmifarmacy']=="Administrador"){
            $total_usuarios=$ins_login->datos_tabla("Normal","usuario WHERE usuario_id!='1' AND usuario_id!='".$_SESSION['id_farmifarmacy']."'","usuario_id",0);
    ?>
