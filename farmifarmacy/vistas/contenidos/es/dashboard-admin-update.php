<?php
    if($ins_login->encryption($_SESSION['id_farmifarmacy'])!=$pagina[2]){
        ...
        <fieldset class="mb-4">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <?php if($_SESSION['cargo_farmifarmacy']=="Administrador" && $campos['usuario_id']!=1 && $ins_login->encryption($_SESSION['id_farmifarmacy'])!=$pagina[2]){ ?>
                    <div class="col-12 col-md-6">
