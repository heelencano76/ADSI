...
<body id="main-body" class="scroll">
    <?php
        ...
        if(isset($pagina[0]) && DASHBOARD==$pagina[0]){
            ...
            if($vistas=="login" || $vistas=="404"){
                ...
                if(!isset($_SESSION['token_farmifarmacy']) || !isset($_SESSION['id_farmifarmacy']) || !isset($_SESSION['nombre_farmifarmacy']) || !isset($_SESSION['apellido_farmifarmacy']) || !isset($_SESSION['usuario_farmifarmacy']) || !isset($_SESSION['cargo_farmifarmacy'])){
    ...
    <?php
            ...
            if($vistas=="404"){
                ...
                if(isset($_SESSION['cargo_farmifarmacy']) && ($_SESSION['cargo_farmifarmacy']=="Administrador" || $_SESSION['cargo_farmifarmacy']=="Cajero")){
                    include "./vistas/inc/log_out_admin.php";
                }
            }
        }
