	...
	class loginControlador extends mainModel{
		...
		public function iniciar_sesion_administrador_controlador(){
			...
			if($datos_cuenta->rowCount()==1){
				...
				$_SESSION['id_farmifarmacy']=$row['usuario_id'];
				$_SESSION['nombre_farmifarmacy']=$row['usuario_nombre'];
				$_SESSION['apellido_farmifarmacy']=$row['usuario_apellido'];
				$_SESSION['genero_farmifarmacy']=$row['usuario_genero'];
				$_SESSION['usuario_farmifarmacy']=$row['usuario_usuario'];
				$_SESSION['cargo_farmifarmacy']=$row['usuario_cargo'];
				$_SESSION['foto_farmifarmacy']=$row['usuario_foto'];
				$_SESSION['token_farmifarmacy']=mainModel::encryption(uniqid(mt_rand(), true));
		...
		public function cerrar_sesion_administrador_controlador(){
			...
			if($token==$_SESSION['token_farmifarmacy'] && $usuario==$_SESSION['usuario_farmifarmacy']){
				unset($_SESSION['id_farmifarmacy']);
				unset($_SESSION['nombre_farmifarmacy']);
				unset($_SESSION['apellido_farmifarmacy']);
				unset($_SESSION['genero_farmifarmacy']);
				unset($_SESSION['usuario_farmifarmacy']);
				unset($_SESSION['cargo_farmifarmacy']);
				unset($_SESSION['foto_farmifarmacy']);
				unset($_SESSION['token_farmifarmacy']);
				$alerta=[
